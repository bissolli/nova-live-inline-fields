<template>
    <div class="relative flex items-stretch" @dblclick="showInput" :class="{ flashGreen }">
        <span v-show="!isInputVisible" class="whitespace-no-wrap border-b border-dashed border-color cursor-pointer">{{ field.value || '—' }}</span>
        <input
